...
<div class="navbar fixed-top">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link active" data-toggle="tab"
			href="${pageContext.request.contextPath}/gerant"><strong>Home</strong></a></li>
			
		<li class="nav-item"><a class="nav-link" data-toggle="tab"
			href="${pageContext.request.contextPath}/nouveauconseiller"><strong>Nouveau Conseiller</strong></a></li>
	<!-- 	
		<li class="nav-item"><a class="nav-link" data-toggle="tab"
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><strong>Creer un nouveau Conseiller</strong></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="${pageContext.request.contextPath}/nouveauconseiller">
...
<div>
 ...
 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i><h3><strong> Liste Conseiller </strong></h3></div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  <th>Nom</th>
                  <th>Prenom</th>
                  <th>Reference Conseiller</th>                 
                  <th>Modification Conseiller</th>
                  <th>Suppression</th>
                </tr>
              </thead>
              <tfoot>
              ...
              <tbody>
                  ...
                  <td><a href="edit/${conseiller.id}" class="btn btn-info" role="button">Modification</a></td>
                  
              <td><a href="delete/${conseiller.id}" class="btn btn-info" role="button">Supprimer</a></td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
